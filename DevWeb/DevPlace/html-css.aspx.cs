...
{
    public partial class html_css : System.Web.UI.Page
    {
        ...
        public static DevPlaceSection GetHtmlMenu(string param)
        {
            ...
            sections.CursesItems = dm.GetItemCursesTemplate((int)EnumTechnology.HTML);
            sections.CurseFees = dm.GetItemCurseFeesTemplate((int)EnumTechnology.HTML);

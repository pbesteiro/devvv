<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BasicDevs.aspx.cs" Inherits="CruceroDelNorte.BasicDevs" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <section>
            <div class="line">
                <h3 class="developer-text ">Capacitaciones Intensivas - Programación Básica</h3>
            </div>
                ...
                <div class="card-developer">
                    <a href="html-css.aspx">
                        ...
                        <div class="general-developer">
                            <h1 class="card-title-developer">HTML y CSS</h1>
                            <p class="card-text-developer">
                                El objetivo principal del curso es enseñarte como maquetar una pagina web utiliando el lenguaje HTML y dandole el stilo con todo el poder de CSS.
            ...
            <div class="item-container">
                <div class="card-developer">
                    <a href="js-basico.aspx">
                        ...
                        <div class="general-developer">
                            <h1 class="card-title-developer">Javascript Básico</h1>
                            <p class="card-text-developer">
                                El objetivo principal del curso es enseñarte JS hasta llevarte a un nivel intermedio que te permitirá poder intrducirte en el mundo de JavaScript.

...
{
    public partial class ux_ui : System.Web.UI.Page
    {
        ...
        public static DevPlaceSection GetHtmlMenu(string param)
        {
            ...
            sections.CursesItems = dm.GetItemCursesTemplate((int)EnumTechnology.UX_UI);
            sections.CurseFees = dm.GetItemCurseFeesTemplate((int)EnumTechnology.UX_UI);

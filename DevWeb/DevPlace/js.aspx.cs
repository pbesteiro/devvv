...
namespace CruceroDelNorte
{
    public partial class js : System.Web.UI.Page
    {
        ...
        public static DevPlaceSection GetHtmlMenu(string param)
        {
            ...
            sections.CursesItems = dm.GetItemCursesTemplate((int)EnumTechnology.JAVASCRIPT);
            sections.CurseFees = dm.GetItemCurseFeesTemplate((int)EnumTechnology.JAVASCRIPT);

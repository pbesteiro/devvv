<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DataBase.aspx.cs" Inherits="CruceroDelNorte.DataBase" %>
...
<body>
    ...
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner">
        <div  class="carousel-item active carousel-basededatos">
          <div class="carousel-title-basededatos">
  ...
  <section>
    <div class="line">
      <h3 class="developer-text ">Formaciones Intensivas - Fundamentales</h3>
    </div>
                    ...
                    <a href="sql.aspx">
                        <div style="background: #FF9100;" class="additional-developer">
                            <div class="user-card-developer">
                                ...
                                <div>
                                    <img class="img-card-developer" src="assets/images/icons-cursos/sql-server.svg" alt="" />
                                </div>
                                <div>
                        ...
                        <div class="general-developer">
                            <h1 class="card-title-developer">SQL</h1>
                            <p class="card-text-developer">
                                El objetivo del curso es darte los conocimientos para que entiendas que es una base de datos y cómo funciona, utilizando los leguajes DDL y DML para la creacion y uso de la misma.

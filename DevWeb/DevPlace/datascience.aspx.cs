...
{
    public partial class datascience : System.Web.UI.Page
    {
        ...
        public static DevPlaceSection GetHtmlMenu(string param)
        {
            ...
            sections.CursesItems = dm.GetItemCursesTemplate((int)EnumTechnology.SCIENCE);
            sections.CurseFees = dm.GetItemCurseFeesTemplate((int)EnumTechnology.SCIENCE);

...
{
    public partial class ReactJs : System.Web.UI.Page
    {
        ...
        public static DevPlaceSection GetHtmlMenu(string param)
        {
            ...
            sections.CursesItems = dm.GetItemCursesTemplate((int)EnumTechnology.React);
            sections.CurseFees = dm.GetItemCurseFeesTemplate((int)EnumTechnology.React);

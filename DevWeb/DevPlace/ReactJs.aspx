                            ...
                            <div class="container colorwhite">        
                                <div class="row">
                                    <div class="col-sm-12 col-md-6 pd-120" >
                                        <h4><u>CURSOS</u> > <u>PARA DEVELOPERS </u> > FRONT END > REACT</h4>
                                        <h4 class="pt-3">MODALIDAD ONLINE <b>EN VIVO</b></h4>
                                        <h1 class="pt-1">REACT</h1>
                                        ...
                                        <h4><i class="fas fa-check"></i> 2 horas por sesión</h4>
                                         ...
                                         <div class="row pt-3">
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <a href="assets/programas/reactjs.pdf" target="_blank"><button type="button" class="btn btn-primary head-button-card head-button-card-tans">Descargar Programa</button> </a>
                                            </div>
                                         </div>
                      ...
                      <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-4">
                                <h6 class="card-subtitle mb-2 text-muted title-card-new">REACT</h6>
        ...
        <div class="container pt-5 pb-5">        
            <div class="row m-4">
                <div class="col-sm-7">
                    ...
                    <p class="">El objetivo principal del curso es enseñarte ReactJS, empezando de cero hasta llevarte a un nivel avanzado y competitivo. Este curso te ayudará a introducirte fácilmente al framework de JavaScript más usado en el mercado laboral. ReactJS te abrirá un mundo de posibilidades en la creación de interfaces dinámicas y escalables, ya que este fue diseñado específicamente para el desarrollo de potentes interfaces de usuario. El curso tiene como meta lograr que te interiorices con las buenas prácticas en desarrollo de Front End. ReactJS es una de las librerías de JavaScript más potentes y populares que existe. Dentro de las aplicaciones más destacadas creadas con ReactJS, se encuentra Instagram, una de las redes sociales más populares del mundo.
                    </p>
                </div>
                <div class="col-sm-5">

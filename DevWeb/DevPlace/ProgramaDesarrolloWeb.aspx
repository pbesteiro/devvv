                            ...
                            <div class="container colorwhite">        
                                <div class="row">
                                    <div class="col-sm-12 col-md-6 pd-120" >
                                        ...
                                        <h4 class="pt-5"><i class="fas fa-check"></i> Capacidad de 25 alumnos</h4>
                                        <h4><i class="fas fa-check"></i> Dura 4 meses</h4>
                      ...
                      <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-4">
                                ...
                                <p class="card-text pt-4">Dura 4 meses</p>
...
●Utilización CSS: Aplicaremos los estilos del sitio web utilizando clases, etiquetas y todo el poder de CSS.<br />
            ...
            <div class="row pt-5  m-4">
                ...
                <div class="col-sm-6">
                    <h3>El programa está dirigido a personas con experiencia mínima o nula en programación.</p>
                    <div class="row pt-2">
                        <div class="col-sm-6">
                            <h5>Requisitos</h5>
                            <p>
                                <i class="fas fa-check"></i> Conocimientos básicos de programación.
                            </p>
                        </div>
                        <div class="col-sm-6">

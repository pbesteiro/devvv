...
{
    public partial class ProgramaDesarrolloWeb : System.Web.UI.Page
    {
        ...
        public static DevPlaceSection GetHtmlMenu(string param)
        {
            ...
            sections.CursesItems = dm.GetItemCursesTemplate((int)EnumTechnology.DESARROLLO_WEB);
            sections.CurseFees = dm.GetItemCurseFeesTemplate((int)EnumTechnology.DESARROLLO_WEB);

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProgramsDevs.aspx.cs" Inherits="CruceroDelNorte.ProgramsDevs" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <section>
            <div class="line">
                <h3 class="developer-text ">Capacitaciones Intensivas - Programación Full Stack</h3>
            </div>
                ...
                <div class="card-developer">
                    <a href="js-basico.aspx">
                        ...
                        <div class="general-developer">
                            <h1 class="card-title-developer">Full Stack JS</h1>
                            <p class="card-text-developer">
                                El objetivo de este programa es transformarte en un desarrollador Full Stack con sólidos conocimientos en JS, Node JS y Angular JS.
